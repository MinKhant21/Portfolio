  ...
  return (
    <div >
      ...
      <div className="container flex  justify-center  mb-5" >
        <div className=" flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md w-[30rem] md:w-full md:max-w-[70rem] flex-col  md:flex-row  mx-auto">
          <div className=" w-full md:w-2/5 m-0 overflow-hidden text-gray-700 bg-white rounded-r-none bg-clip-border rounded-xl shrink-0">
