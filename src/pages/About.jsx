        ...
        <div className=" flex-row md:flex justify-between gap-40 mt-24 ">
            ...
            <div className="mt-6 md:mt-0">
              <ul className="list-disc space-y-10 text-justify">
                <li>I have over 3 years of experience in Software development. In the earlier stages of my career, I built hundreds of company portfolio websites tailored to customer needs using HTML, CSS,  and jQuery</li>
                <li>Starting in 2020, I transitioned to working with React.js, Next.js, and Redux, accumulating 3 years of experience in React.js, over 3 years in Node.js, and 2 years in TypeScript. I also have experience with Scss, Material-UI (@mui),Ant Design, Bootstrap, and Tailwind.</li>
                ...
                <li>Currently, I'm actively pursuing professional development in AWS and Python, aiming to expand my expertise into Software development.</li>
              </ul>
            </div>
        </div>
    </div>
