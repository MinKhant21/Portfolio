...
export default function Experience() {
  return (
    <div className="  my-10 h-screen flex flex-col justify-center items-center mb-10">
        ...
        <details className="  collapse  collapse-plus border border-base-300   shadow-md">
          <summary className="collapse-title text-lg md:text-xl font-medium    ">
            <div className=" flex justify-between items-center">
              <p className="">Full-Stack Developer @ EDKA Digital Ltd </p>
     ...
     {/* Secret */}
      <div className=" mx-1 md:w-1/2 my-5">
        <details className="  collapse  collapse-plus border border-base-300   shadow-md">
          <summary className="collapse-title text-lg md:text-xl font-medium    ">
            <div className=" flex justify-between items-center">
              <p className="">PHP Developer @ Secret Code Ltd </p>
     ...
     {/* ZED */}
      <div className=" mx-1 md:w-1/2 my-5">
        <details className="  collapse  collapse-plus border border-base-300   shadow-md">
          <summary className="collapse-title text-lg md:text-xl font-medium    ">
            <div className=" flex justify-between items-center">
              <p className="">Junior Web Developer @ Zed Myanmar Digital Ltd </p>
