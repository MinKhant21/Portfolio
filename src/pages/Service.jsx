     ...
     <div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
         <div class="container xl:max-w-6xl mx-auto px-4">
             <header class="text-center mx-auto mb-12 lg:px-20">
                 ...
                 <svg version="1.1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 100 60" style={{margin:" 0 auto",height: "35px"}} >
                     <circle cx="50.1" cy="30.4" r="5" class="stroke-primary" style={{fill: "transparent",strokeWidth: "2",strokemiterlimit: "10",}}></circle>
                     <line x1="55.1" y1="30.4" x2="100" y2="30.4" class="stroke-primary" style={{strokewidth: "2",strokemiterlimit: "10"}}></line>
                     <line x1="45.1" y1="30.4" x2="0" y2="30.4" class="stroke-primary" style={{strokewidth: "2",strokemiterlimit: "10"}}></line>
                 </svg>
             ...
             <div class="flex flex-wrap flex-row -mx-4 text-center">
                 <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{visibility: "visible", animationDuration: "1s", animationName: "fadeInUp"}}>
                 ...
                 <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style={{visibility: "visible", animationduration: "1s", animationdelay: "0.1s", animationname: "fadeInUp"}}>
                     <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                         <div class="inline-block text-gray-900 mb-4">
                 ...
                 <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s", animationName: "fadeInUp"}}>
                     <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                         <div class="inline-block text-gray-900 mb-4">
